...
///sun night
    ...
    circleSolid(120.0f,130.0f,15.0);
}
void skyN()
{
...
//    glEnd();
    ...
    glColor3ub( 255, 255, 255);
    circleSolid(60.0f,180.0f,1.0);

    glColor3ub( 255, 255, 255);
    circleSolid(80.0f,150.0f,1.0);
    glColor3ub( 255, 255, 255);
    circleSolid(-80.0f,130.0f,1.0);

    glColor3ub( 255, 255, 255);
    circleSolid(50.0f,160.0f,1.0);



    glColor3ub( 255, 255, 255);
    circleSolid(85.0f,170.0f,1.0);
    glColor3ub( 255, 255, 255);
    circleSolid(90.0f,168.0f,1.0);




    glColor3ub( 255, 255, 255);
    circleSolid(170.0f,130.0f,1.0);

    glColor3ub( 255, 255, 255);
    circleSolid(160.0f,135.0f,1.0);

    glColor3ub( 255, 255, 255);
    circleSolid(140.0f,140.0f,1.0);

    glColor3ub( 255, 255, 255);
    circleSolid(-80.0f,0.56f,1.0);

    glColor3ub( 255, 255, 255);
    circleSolid(-35.0f,0.39f,1.0);

    //***

    glColor3ub( 255, 255, 255);
    circleSolid(-70.0f,150.0f,1.0);

    glColor3ub( 255, 255, 255);
    circleSolid(-60.0f,140.0f,1.0);

    glColor3ub( 255, 255, 255);

    circleSolid(-50.0f,150.0f,1.0);

    glColor3ub( 255, 255, 255);
    circleSolid(-40.0f,130.0f,1.0);

    glColor3ub( 255, 255, 255);
    circleSolid(-90.0f,120.0f,1.0);


    glColor3ub( 255, 255, 255);
    circleSolid(10.0f,40.0f,1.0);


    glColor3ub( 255, 255, 255);
    circleSolid(-10.0f,39.0f,1.0);


    glColor3ub( 255, 255, 255);
    circleSolid(-15.0f,57.0f,1.0);

    glColor3ub( 255, 255, 255);
    circleSolid(0.0f,55.0f,1.0);
...
void treeN()
{
    ...
    glVertex2f(75.0f, -76.0f);    //right
    glVertex2f(82.0f, -65.0f);

    glVertex2f(73.0f, -76.0f);     //middle
    glVertex2f(73.0f, -55.0f);
    glEnd();

    glColor3ub(0, 102, 0);
    circleSolid(63.0f, -65.0f, 4.0);  //1
    glColor3ub(0, 204, 0);
    circleSolid(67.0f, -65.0f, 4.0);         //2
    glColor3ub(0, 153, 51);
    circleSolid(69.0f, -65.0f, 4.0);         //3

    glColor3ub( 0, 153, 0);
    circleSolid(73.0f, -59.0f, 5.0);      //4


    circleSolid(82.0f, -65.0f, 4.00);     //5

    circleSolid(80.02f, -65.0f, 4.00);        //6

    glColor3ub( 0, 77, 0 );
    circleSolid(77.0f, -65.0f, 4.0);      //7
...
void house()
{
    ...
    glVertex2f(-88.0f, -100.0f);
    glVertex2f(-88.0f, -70.0f);
    glVertex2f(-100.0f,-70.0f);

    glColor3ub(255,255,255); //pipe
    glVertex2f(-97.0, -70.0f);
    glVertex2f(-97.0f, -64.0f);
    glVertex2f(-95.0f, -64.0f);
    glVertex2f(-95.0f, -70.0f);

    glColor3ub(102, 102, 255);         //window   01
    glVertex2f(-99.0f, -96.0f);
    glVertex2f(-95.0f, -96.0f);
    glVertex2f(-95.0f, -91.0f);
    glVertex2f(-99.0f, -91.0f);

    glColor3ub(102, 102, 255);       //02
    glVertex2f(-99.0f, -88.0f);
    glVertex2f(-95.0f, -88.0f);
    glVertex2f(-95.0f, -83.0f);
    glVertex2f(-99.0f, -83.0f);

    glColor3ub(102, 102, 255);         //03
    glVertex2f(-99.0f, -81.0f);
    glVertex2f(-95.0f, -81.0f);
    glVertex2f(-95.0f, -76.0f);
    glVertex2f(-99.0f, -76.0f);

//////////////////////

    glColor3ub(102, 102, 255);     //UPPER WINDOW 03
    glVertex2f(-93.0f, -81.0f);
    glVertex2f(-89.0f, -81.0f);
    glVertex2f(-89.0f, -76.0f);
    glVertex2f(-93.0f, -76.0f);


    glColor3ub(102, 102, 255);       //02
    glVertex2f(-93.0f, -88.0f);
    glVertex2f(-89.0f, -88.0f);
    glVertex2f(-89.0f, -83.0f);
    glVertex2f(-93.0f, -83.0f);

        glColor3ub(102, 102, 255);         //03
    glVertex2f(-93.0f, -96.0f);
    glVertex2f(-89.0f, -96.0f);
    glVertex2f(-89.0f, -91.0f);
    glVertex2f(-93.0f, -91.0f);

    //LEFT SIDE HOUSE01 COMPLETE
    ...
    glVertex2f(-78.0f, -42.0f);
    glVertex2f(-73.0f, -42.0f);
    glVertex2f(-73.0f, -50.0f);


    glColor3ub(102, 102, 255);         //window   01
    glVertex2f(-80.0f, -96.0f);
    glVertex2f(-75.0f, -96.0f);
    glVertex2f(-75.0f, -86.0f);
    glVertex2f(-80.0f, -86.0f);


   glColor3ub(102, 102, 255);         //02
    glVertex2f(-80.0f, -83.0f);
    glVertex2f(-75.0f, -83.0f);
    glVertex2f(-75.0f, -73.0f);
    glVertex2f(-80.0f, -73.0f);
   ...
   glColor3ub(102, 102, 255);         //03
    ...
    glColor3ub(102, 102, 255);         //MIDDLE 01
    glVertex2f(-72.0f, -96.0f);
    glVertex2f(-67.0f, -96.0f);
    glVertex2f(-67.0f, -86.0f);
    glVertex2f(-72.0f, -86.0f);

       glColor3ub(102, 102, 255);         //MIDDLE 02
    glVertex2f(-72.0f, -83.0f);
    glVertex2f(-67.0f, -83.0f);
    glVertex2f(-67.0f, -73.0f);
    glVertex2f(-72.0f, -73.0f);


   glColor3ub(102, 102, 255);         //MIDDLE 03
    glVertex2f(-72.0f, -70.0f);
    glVertex2f(-67.0f, -70.0f);
    glVertex2f(-67.0f, -60.0f);
    glVertex2f(-72.0f, -60.0f);



       glColor3ub(102, 102, 255);         //RIGHT  01
    glVertex2f(-64.0f, -96.0f);
    glVertex2f(-59.0f, -96.0f);
    glVertex2f(-59.0f, -86.0f);
    glVertex2f(-64.0f, -86.0f);

       glColor3ub(102, 102, 255);         //RIGHT  02
    glVertex2f(-64.0f, -83.0f);
    glVertex2f(-59.0f, -83.0f);
    glVertex2f(-59.0f, -73.0f);
    glVertex2f(-64.0f, -73.0f);


   glColor3ub(102, 102, 255);         //RIGHT  03
    glVertex2f(-64.0f, -70.0f);
    glVertex2f(-59.0f, -70.0f);
    glVertex2f(-59.0f, -60.0f);
...
/////////////////////////////////////////////////////////////////////////////////////////////////////
   ...
   glColor3ub(102, 102, 255);         //window   01
    glVertex2f(-37.0f, -96.0f);
    glVertex2f(-31.0f, -96.0f);
    glVertex2f(-31.0f, -86.0f);
    glVertex2f(-37.0f, -86.0f);


       glColor3ub(102, 102, 255);         //window  02
    glVertex2f(-37.0f, -83.0f);
    glVertex2f(-31.0f, -83.0f);
    glVertex2f(-31.0f, -73.0f);
    glVertex2f(-37.0f, -73.0f);



       glColor3ub(102, 102, 255);         //window 03
    ...
    glVertex2f(-37.0f, -60.0f);
       ...
       glColor3ub(102, 102, 255);         //window 04
    glVertex2f(-37.0f, -57.0f);
    glVertex2f(-31.0f, -57.0f);
    glVertex2f(-31.0f, -47.0f);
    glVertex2f(-37.0f, -47.0f);
    ...
    //middle window
     ...
     glColor3ub(102, 102, 255);         //window   01
    glVertex2f(-29.0f, -96.0f);
    glVertex2f(-23.0f, -96.0f);
    glVertex2f(-23.0f, -86.0f);
    glVertex2f(-29.0f, -86.0f);


       glColor3ub(102, 102, 255);         //window  02
    glVertex2f(-29.0f, -83.0f);
    glVertex2f(-23.0f, -83.0f);
    glVertex2f(-23.0f, -73.0f);
    ...
    glVertex2f(-29.0f, -60.0f);
       ...
       glColor3ub(102, 102, 255);         //window 04
    glVertex2f(-29.0f, -57.0f);
    glVertex2f(-23.0f, -57.0f);
    glVertex2f(-23.0f, -47.0f);
    ...
    //right side window\
     ...
     glColor3ub(102, 102, 255);         //window   01
    glVertex2f(-21.0f, -96.0f);
    glVertex2f(-15.0f, -96.0f);
    glVertex2f(-15.0f, -86.0f);
    glVertex2f(-21.0f, -86.0f);


       glColor3ub(102, 102, 255);         //window  02
    glVertex2f(-21.0f, -83.0f);
    glVertex2f(-15.0f, -83.0f);
    glVertex2f(-15.0f, -73.0f);
    glVertex2f(-21.0f, -73.0f);
    ...
    glVertex2f(-21.0f, -60.0f);
       ...
       glColor3ub(102, 102, 255);         //window 04
    glVertex2f(-21.0f, -57.0f);
    glVertex2f(-15.0f, -57.0f);
    glVertex2f(-15.0f, -47.0f);
    glVertex2f(-21.0f, -47.0f);
